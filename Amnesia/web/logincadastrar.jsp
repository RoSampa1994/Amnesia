...
<script type="text/javascript">
  function validarcadastro(){
	...
	document.formLoginCadastrar.submit();
  }
</script>
  </head>

  <body style="background: #337cbb">
    <form name="formLoginCadastrar" action="logininsert.jsp" method="post">
        <div class="container">
          <div class="bloco-login col-md-4 text-center">
            <h3>LOGIN</h3>
              ...
              <input name="txtemail" id="campos_email" placeholder="EMAIL" class="col-md-9 col-sm-12 col-xs-12" type="text">              
              <input name="commit" value="CRIAR" class="submit col-md-4 col-sm-12 col-xs-12" type="button" onclick="validarcadastro()">
          </div>
        </div>
    </form>
